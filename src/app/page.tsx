...
const pricingTiers = [
  {
    ...
    price: "$1,000",
    period: "MXN único",
    description: "Para conocer dónde estás parado. Diagnóstico rápido en 48 horas.",
    features: [
      { label: "Diagnóstico Express 48hrs", included: true },
      { label: "Mapa de procesos actuales", included: true },
      { label: "Top 3 oportunidades de automatización", included: true },
      { label: "Reporte PDF ejecutivo", included: true },
      { label: "Reuniones de seguimiento", included: false },
      { label: "Implementación incluida", included: false },
    ],
    ctaLabel: "Comenzar con Explorador",
    ctaHref: "/diagnostico?tier=explorador",
  },
  {
    name: "Estudio",
    price: "$5,000",
    period: "MXN único",
    description: "Para planear tu transformación con una hoja de ruta detallada.",
    features: [
      { label: "Diagnóstico profundo (5 días)", included: true },
      { label: "Entrevistas con tu equipo", included: true },
      { label: "Hoja de ruta 12 meses", included: true },
      { label: "2 sesiones de revisión", included: true },
      { label: "Benchmarks de industria", included: true },
      { label: "Implementación incluida", included: false },
    ],
    ctaLabel: "Comenzar con Estudio",
    ctaHref: "/diagnostico?tier=estudio",
  },
  {
    name: "Transformación",
    price: "$10,000",
    period: "MXN único",
    description: "Para comenzar a automatizar con implementación real incluida.",
    features: [
      { label: "Todo lo del plan Estudio", included: true },
      { label: "1 automatización implementada", included: true },
      { label: "Pruebas y puesta en marcha", included: true },
      { label: "Soporte 30 días post-entrega", included: true },
      { label: "Capacitación de tu equipo", included: true },
      { label: "Soporte mensual continuo", included: false },
    ],
    ctaLabel: "Comenzar con Transformación",
    ctaHref: "/diagnostico?tier=transformacion",
    highlighted: true,
    badge: "Más popular",
  },
  {
    ...
    price: "$15,000",
    period: "MXN único",
    description: "Para escalar en grande con múltiples automatizaciones integradas.",
    features: [
      { label: "Todo lo del plan Transformación", included: true },
      { label: "3 automatizaciones implementadas", included: true },
      { label: "Integración de sistemas existentes", included: true },
      { label: "Soporte 90 días post-entrega", included: true },
      { label: "Reuniones mensuales de revisión", included: true },
      { label: "Capacitación completa del equipo", included: true },
    ],
    ctaLabel: "Comenzar con Empresa",
    ctaHref: "/diagnostico?tier=empresa",
  },
];
