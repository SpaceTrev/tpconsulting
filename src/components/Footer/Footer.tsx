...
const serviciosLinks = [
  ...
  { href: "/servicios#whatsapp", label: "WhatsApp IA" },
  { href: "/servicios#dashboards", label: "Dashboards" },
  { href: "/servicios#facturacion", label: "Facturación" },
  { href: "/servicios#agenda", label: "Agendamiento" },
  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.inner}>
        ...
        <div className={styles.col}>
          <p className={styles.colLabel}>Servicios</p>
        ...
        <div className={styles.col}>
          <p className={styles.colLabel}>Empresa</p>
          <ul className={styles.colLinks} role="list">
        ...
        <div className={styles.col}>
          <p className={styles.colLabel}>Conectar</p>
          <ul className={styles.colLinks} role="list">
            <li>
              <Link
                href="https://wa.me/13038299013?text=Hola%2C%20me%20interesa%20saber%20m%C3%A1s%20sobre%20sus%20servicios%20de%20automatizaci%C3%B3n"
